...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    useEffect(() => {
      if (containerRef.current && containerIntersectionRef.current !== containerRef.current) {
        (containerIntersectionRef as React.MutableRefObject<HTMLElement | null>).current = containerRef.current;
      }
    }, []);
